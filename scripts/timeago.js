...
function () {
  ...
  **/
   ...
   * var timeago = timeagoLib(null, 'en'); // set default locale is `en`.
   * var timeago = timeagoLib('2016-09-10', 'en'); // the relative date is 2016-09-10, and locale is en, so the 2016-09-11 will be 1 day ago.
  **/
   ...
   * - locale: the formated string's locale name, e.g. en
   *
   * How to use it?
  ...
  **/
   ...
   * var timeago = timeagoFactory(null, 'en'); // set default locale is `en`.
   * var timeago = timeagoFactory('2016-09-10', 'en'); // the relative date is 2016-09-10, and locale is en, so the 2016-09-11 will be 1 day ago.
   **/
   ...
   * - locale: locale name, e.g. en, notice the standard.
